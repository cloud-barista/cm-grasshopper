...
require (
	...
	github.com/cloud-barista/cm-honeybee/agent v0.0.0-20260623094420-08150a2e7a74
	github.com/cloud-barista/cm-honeybee/server v0.0.0-20260623094420-08150a2e7a74
