...
require (
	github.com/cloud-barista/cm-honeybee/agent v0.0.0-20250929070435-0d466707349d
	github.com/cloud-barista/cm-honeybee/server v0.0.0-20250929070435-0d466707349d
